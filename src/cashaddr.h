 ...
 * may be preceded by a prefix such as "ergon:", "bchtest:", or "bchreg:".
 * If no prefix is specified, 'default_prefix' is assumed. If default_prefix is
 * null or empty, "ergon" is assumed. Make sure default_prefix has no
...
#define CASHADDR_PREFIX_MAIN "ergon"
